        ...
        <table className="w-full text-sm">
          ...
          <thead className="bg-[var(--superficie-sutil)]">
            <tr className="border-b border-[var(--borda-forte)] text-left">
              ...
              <th className="px-2.5 py-1.5 font-mono text-2xs uppercase tracking-wide text-[var(--texto-3)]">Descricao</th>
              <th className="px-2.5 py-1.5 font-mono text-2xs uppercase tracking-wide text-[var(--texto-3)]">Referencia</th>
